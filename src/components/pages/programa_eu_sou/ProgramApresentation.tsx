...
export default function ProgramApresentation() {
	return (
		<section className="flex w-full flex-col items-center gap-32 overflow-hidden bg-custom-gray-08 px-8 py-32 text-white lg:px-32 xl:items-start">
			{/* Nossa abordagem */}
			<Approach />
			...
			<div className="w-full">
				...
				<div className="grid grid-cols-2 items-center gap-8 max-xl:grid-cols-1">
									...
									accordionList={[
										...
										},
										{
											...
											content: (
												<div>
													<p className="mb-6">
														Nesse módulo os participantes irão conhecer os principais
														conceitos ligados as tecnologias do momento e como elas podem ser
														aplicadas no âmbito da saúde. A seguir os principais conceitos que
														serão abordados:
													</p>
													<ListItems
														items={[
										...
										},
										{
											...
											content: (
												<div>
													<p className="mb-6">
														Nesse módulo os participantes irão aprender vários conceitos
														ligados ao desenvolvimento humano e como ele pode ser alcançado
														através da aréa da sáude e da tecnologia. A seguir os principais
														tópicos abordados:
													</p>
													<ListItems
														items={[
					...
					<div>
						<div className="text-custom-pastel-blue-02 rounded-lg bg-custom-gray-10 p-8 text-xl max-sm:p-6 max-sm:text-base max-xs:text-center">
							<div className="mb-8 flex items-center justify-between gap-8 max-sm:flex-col max-sm:items-start">
								<div>
									<span className="font-poppins text-lg text-custom-gray-04">
										Fase 2
									</span>
									...
									accordionList={[
										{
											...
											content: (
												<p className="mb-6 text-custom-gray-01">
													Orientação individualizada sobre o medicamento escolhido, seus
													efeitos e como se preparar para a próxima etapa
												</p>
											),
										},
										{
